  ...
  <div class="card mt-10">
        <div class="card-header">
            <div class="float-left">
                <h5> Content Management >> Services  </h5>
            </div>
        </div>
        <form method="POST" action="{{route('postServicesContent')}}">
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <label for="">Page Content</label>
                        <textarea class="form-control tiny-textarea" id="" name="services_content_node_1" rows="10">{{$content['services_content_node_1']}}</textarea>
                        <span class="text-danger"> 
                            @if($errors->has('services_content_node_1'))
                                {{ $errors->first('services_content_node_1') }}
                            @endif
                        </span>
                    </div>
                </div>
